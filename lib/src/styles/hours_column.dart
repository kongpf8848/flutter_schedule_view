...
class HoursColumnStyle {
  ...
  final TextStyle timeRangeTextStyle;
  ...
  const HoursColumnStyle({
    ...
    TextStyle? timeRangeTextStyle,
        ...
        timeRangeTextStyle = timeRangeTextStyle ?? const TextStyle(color: Colors.black54);
  ...
  HoursColumnStyle copyWith({
    ...
    TextStyle? timeRangeTextStyle
      ...
      HoursColumnStyle(
        ...
        timeRangeTextStyle: timeRangeTextStyle ?? this.timeRangeTextStyle
      );
}
