...
typedef EventResizeCallback = Function(FlutterWeekViewEvent event, DateTime newDateTime);
...
class ResizeEventOptions {
  ...
  final EventResizeCallback onEventResizedUp;
  final EventResizeCallback onEventResizeUpUpdate;
  /// Triggered when the user performs a resize in an event.
  final EventResizeCallback onEventResizedDown;

  final EventResizeCallback onEventResizeDownUpdate;
  ...
  ResizeEventOptions({
    required this.onEventResizedUp,
    required this.onEventResizeUpUpdate,
    required this.onEventResizedDown,
    required this.onEventResizeDownUpdate,
